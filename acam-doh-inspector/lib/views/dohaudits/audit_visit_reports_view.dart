...
class AuditVisitReportsView extends ConsumerWidget {
  const AuditVisitReportsView(this.auditVisit, {Key? key}) : super(key: key);
...
class ReportItemWidget extends ConsumerWidget {
  const ReportItemWidget({Key? key, required this.report, required this.reportsProvider, required this.auditVisit}) : super(key: key);
  ...
  loadReport(BuildContext context, ReportsProvider provider, ReportDescription report) async {
    ...
    provider.loadReportByDescription(report, {
      ...
      //     "capid": auditVisit.recordId,
      //     "b1_alt_id": auditVisit.customId,
      //     // "RECID": auditVisit.customId,
      //   }
    });
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              provider.getCleanedUpErrorMessage(),
              style: Theme.of(context).textTheme.headlineMedium,
            )
          ],
        ),
