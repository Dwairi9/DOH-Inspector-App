...
class BetterExpansionTile extends StatefulWidget {
  ...
  final BetterExpansionTileController? expandController;
  ...
  @override
  State<BetterExpansionTile> createState() => _BetterExpansionTileState();
}

class _BetterExpansionTileState extends State<BetterExpansionTile> with SingleTickerProviderStateMixin {
...
//   late Animation<Color?> _iconColor;
  ...
  void initState() {
    ...
    // widget.expandController?.setExpanded(_isExpanded);
    widget.expandController?.onExpansionChanged = (isExpanded) {
      _handleExpandController(isExpanded);
    };
  }

  void _handleExpandController(bool isExpanded) {
    if (isExpanded) {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(color: Color(parseColor("#DFDBD3")), width: 0),
          bottom: BorderSide(color: Color(parseColor("#DFDBD3")), width: 0),
        ),
      ),
      child: Column(
...
class BetterExpansionTileController extends ChangeNotifier {
